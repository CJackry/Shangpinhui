    ...
    <section class="con">
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          <!--放大镜效果-->
          <Zoom :imgUrl="goodInfo.skuDefaultImg" :imgList="goodInfo.skuImageList"/>
          <!-- 小图列表 -->
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="attr in goodAttr" :key="attr.id">
                ...
                <dd :data-changeattr="attr.spuid" v-for="attrValue in attr.spuSaleAttrValueList" :key="attrValue.id"
                    @click="chooseAttr(attrValue.saleAttrName, attrValue.saleAttrValueName)"
                    :class="{'active': checkAttr[attrValue.saleAttrName] === attrValue.saleAttrValueName}">
...
export default {
  ...
  methods: {
    chooseAttr(saleAttrName, saleAttrValueName) {
      if (this.checkAttr[saleAttrName] === saleAttrValueName) {
