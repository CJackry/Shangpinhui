<template>
  <div class="cart">
    ...
    <div class="cart-main">
      ...
      <div class="cart-body">
        <ul class="cart-list" v-for="(good, index) in goodsList" :key="index">
          ...
          <li class="cart-list-con3">
            <div class="item-txt">{{ good.attr }}</div>
          </li>
          ...
          <li class="cart-list-con5">
            ...
            <input autocomplete="off" type="text" :value="good.num" minnum="1" class="itxt">
            <a href="javascript:void(0)" class="plus">+</a>
          </li>
          <li class="cart-list-con6">
            <span class="sum">{{good.price*good.num}}</span>
          </li>
